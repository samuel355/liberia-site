                  ...
                  <div class="col-lg-8">
                    <div class="post-container">
                        ...
                        <div class="boxed-content-item">
                                ...
                                <div class="swiper-container">
                                  <div class="swiper-wrapper lightgallery">
                                    <div class="swiper-slide hov_zoom">
                                      ...
                                      <a href="/images/team/mickey-surveyor-2.jpg" class="box-media-zoom   popup-image">
                                        <i class="fa fa-eye"></i>
                                      </a>
                                    </div>
                                    <div class="swiper-slide hov_zoom">
                                      <img src="/images/team/mickey-surveyor.jpg" alt="">
                                      <a href="/images/team/mickey-surveyor.jpg" class="box-media-zoom   popup-image">
                          ...
                          <div class="text-block post-single_tb">
                            <div class="text-block-container">
                              <p>
                                Mickey M. Garbaye holds the dual roles of Tech Assistant and General Manager at Contours Limited, where he combines technical expertise with managerial acumen to support the company's operations and strategic direction. With a background in surveying, Mickey plays a critical role in ensuring the technical quality and precision of the company's land surveying, mapping, and geo-informatics services.
                              </p>
                              <p>
                                As Tech Assistant, he works alongside the team to implement advanced technologies and methodologies in surveying and mapping, ensuring project deliverables meet the highest professional standards. In his capacity as General Manager, Mickey oversees day-to-day operations, coordinates various departments, and ensures alignment with Contours Limited's business objectives.
                              </p>
                              <p>
                                Mickey's technical skills, leadership, and ability to manage operations effectively make him a cornerstone of the company's success. His dedication to excellence helps Contours Limited maintain its reputation as a leader in the geo-spatial and surveying industry in Liberia.
                              </p>
                            </div>
                            <div class="tagcloud_single">
                              ...
                              <div class="boxed-content">
                                <!--boxed-content-title-->
                                <div class="boxed-content-title">
                                  <h3>Connect with the Surveyor</h3>
                                </div>
                                <!--boxed-content-title end-->
                                <!--boxed-content-item-->
                                <div class="boxed-content-item bc-item_smal_pad">
                                  <div class="social-widget">
                                    <a href="tel:231886246295">
                                      <i class="fa-solid fa-phone"></i>
                                    </a>
                                    <a target="__blank" href="https://wa.me//231886246295">
                      ...
                      <div class="content-nav-fixed dark-bg scale_anim">
                        <ul>
                          <li>
                            <a href="/team-details/ceo" class="ln">
                              <i class="fal fa-long-arrow-left"></i>
                              <span>
                                Prev <strong> - C.E.O</strong>
                              </span>
                            </a>
                          ...
                          <li>
                            <a href="/team-details/administrative-assistant" class="rn">
                              <span>
                                Next <strong> - Admin Assistant</strong>
                              </span>
