function initRenstate() {
  ...
  if ($(".hero-slider").length > 0) {
    ...
    hcarosel.on("slideChangeTransitionEnd", function () {
      var actslidec = $(
        ".hero-slider .swiper-slide.swiper-slide-active .hero-carousel_item"
      ).attr("data-imbg");
      $(".hero-blur-container .bg").css(
        "background-image",
        "url(" + actslidec + ")"
      );
  ...
  if ($(".testimonilas-carousel").length > 0) {
    ...
    var totalSlides2 = $(
      ".testimonilas-carousel  .swiper-slide:not(.swiper-slide-duplicate)"
    ).length;
  ...
  $(".fixed-form").scrollToFixed({
    ...
    limit: function () {
      var a =
        $(".limit-box").offset().top - $(".fixed-form").outerHeight(true) - 20;
      return a;
    },
  });
  ...
  $(".init-fix-column").scrollToFixed({
    ...
    limit: function () {
      var a =
        $(".limit-box").offset().top - $(".init-fix-column").outerHeight(true);
      return a;
    },
  });
  //   appear------------------
  ...
  $(".show-messenger-links").on("click", function (ev) {
    ...
    $(this)
      .parents(".sh-links")
      .find(".messenger-links-container")
      .toggleClass("mlc_vis");
  });
  //   mailchimp------------------
  $("#subscribe").ajaxChimp({
  ...
  b.reload();
  b.init();
  $(".svg-corner_dark").append(
    '<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M40 40V0C40 22.0914 22.0914 40 0 40H40Z" fill="#000000"></path></svg>'
  );
  $(".svg-corner_white").append(
    '<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M40 40V0C40 22.0914 22.0914 40 0 40H40Z" fill="#ffffff"></path></svg>'
  );
  var maxLp = 130;
