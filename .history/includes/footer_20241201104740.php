        ...
        <div class="col-lg-4">
          <div class="footer-widget">
            ...
            <div class="footer-widget-content">
              <p>We blend professionalism with personalized services to ensure every client’s real estate journey is successful. We’ve built a reputation for trustworthiness and innovation, ensuring every transaction is secure and smooth.</p>
            </div>
          </div>
        </div>
        <!-- footer-widget  end-->
